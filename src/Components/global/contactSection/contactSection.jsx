...
//         <form className={style.contactForm} onSubmit={submitHandler}>
...
//               <div
//                 className={`${style.optionInner} ${
//                   flipStates[index] ? style.flipped : ""
//                 }`}
//               >
...
//           <button className={style.panelClose} onClick={() => setPanel(null)}>
//             ✕
//           </button>
